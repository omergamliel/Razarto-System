...
const TOUR_STEPS = [
  ...
  // ======================================================================
  {
    selector: "tour-h2h",
    process: "ראש בראש",
    title: "יצירה — הצעה ישירה",
    body: "כשפותחים משמרת של אדם אחר, הכפתור 'ראש בראש' (מודגש עכשיו) מציע לו החלפה ישירה — משמרת שלכם בתמורה לשלו. בשונה מבקשה כללית, ההצעה מופנית אליו בלבד. (הצגה בלבד.)",
  ...
  // ======================================================================
  {
    ...
    body: "במשמרת של אדם אחר שמתחילה היום, 'הצע לקחת את המשמרת במתנה' (מודגש עכשיו) מציע לקחת אותה ממנו — בלי שום תמורה. אתם, המציעים, מקבלים אישור מיידי (טוסט) ולא הודעה במרכז ההודעות. (הצגה בלבד.)",
    control: { open: "details-other", demo: true },
    radius: 14,
  },
  {
  ...
  // ======================================================================
  {
    ...
    body: "מאותו טופס בקשה, בחירת 'החלפה חלקית' פותחת בורר שעות — מסמנים בו את חלון השעות שתרצו שיכוסה, ולא את כל המשמרת. כך נוצר 'פער' שאחרים יכולים למלא. (הצגה בלבד.)",
    control: { open: "request", demo: true },
    radius: 16,
  },
  {
