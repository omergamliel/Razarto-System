...
export default function ShiftCalendar() {
  ...
  useEffect(() => {
    ...
    // No-op if the ConnectionStatus entity isn't provisioned in the backend —
    // otherwise base44.entities.ConnectionStatus is undefined and every call
    // throws, and the error path below would re-arm this effect on each
    // currentUser refetch, spamming failed requests.
    if (!base44.entities?.ConnectionStatus) return;
