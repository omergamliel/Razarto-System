...
const DEMO_MESSAGES = [
  {
    ...
    body: "רון לדוגמה הציע לך החלפה ראש בראש. אפשר לאשר או לדחות מתוך 'בקשות אליי'.",
  ...
  },
  {
    ...
    type: "gift",
    title: "הוצעה לך מתנה 🎁",
    body: "נגה לדוגמה מציעה לקחת על עצמה את המשמרת שלך במתנה — אשרו כדי להשתחרר מהמשמרת.",
  ...
  },
  {
    ...
    body: "מאי לדוגמה הציעה לכסות חלק מהשעות במשמרת שלך.",
    actionLabel: "צפייה בבקשה",
  ...
  },
  {
    ...
    body: "עידו לדוגמה כיסה את המשמרת שלך — אין צורך להגיע.",
    actionLabel: "צפייה בבקשה",
